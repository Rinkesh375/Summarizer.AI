...
Built with Next.js 16 App Router, Clerk for Auth, React, OpenAI GPT-5.2, Gemini-2.5, LangChain, ShadCN UI components, Tailwind CSS 4, NeonDB, UploadThing, Stripe for payments, TypeScript, TailwindCSS and more.
