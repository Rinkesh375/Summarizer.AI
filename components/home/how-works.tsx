import { how_work_steps } from "@/constants/how-work-steps";
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative">
          {how_work_steps.map((step, index) => (
            <div key={index} className="relative flex items-stretch">
              ...
              {
                index <how_work_steps.length-1 && <div className="hidden md:block top-1/2 -right-4 transform absolute -translate-y-1/2 z-10">
                <MoveRight
                  size={32}
                  strokeWidth={1}
